...
> interface is an internal D3 fiscal-graph prototype (statutory shares plus research figures,
> bannered as pending verification). No official observations are approved for publication.
